...
export default {
  ...
  data () {
    return {
      ...
      termlist: [],
      tasklist: [],
      titles_one: [{ prop: "depart", label: '单位' }, { prop: '理论课', label: '理论课' }, { prop: '实验课', label: '实验课' }, { prop: '上机课', label: '上机课' }, { prop: '实践课', label: '实践课' }, { prop: '课程设计', label: '课程设计' }, { prop: '毕业设计', label: '毕业设计' },
  ...
  methods: {
    search (num) {
      ...
      let posturl = $this.$apilist['alldatagatherbytask'] + '?signature=' + keyvalue;
      // return false;
      console.log(payload)
      this.loading = true
    ...
    exportExcel () {
      ...
      let createvalue = $this.$createObj(payload);
      var keyvalue = createvalue['keyvalue'];
      let posturl = $this.$apilist['exportmaingatherexcel'] + '?signature=' + keyvalue;
      // return false;
      console.log(payload)

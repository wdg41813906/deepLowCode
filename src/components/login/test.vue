            ...
            <div class="editor-outer">
              <div class="x-formula-editor">
                <div class="formula-head">
                  <span class="formula-name">{{ code }}</span>
              ...
              <div class="flex">
                <div class="fields-list">
                  ...
                  <ul class="field-list" style="display: block">
                    <li class="field" name="_widget_1493093397903">
                      <a class="menu-item with-capsule" title="日期时间"
                        ><span>日期时间</span>
                        <div class="menu-capsule style-blue">时间戳</div></a
                      >
                    </li>
                    <li class="field" name="_widget_1493093397926">
                      <a class="menu-item with-capsule" title="下拉复选框"
                        ><span>下拉复选框</span>
                        <div class="menu-capsule style-purple">数组</div></a
                      >
                    </li>
                    <li class="field" name="_widget_1493093397940">
                      <a class="menu-item with-capsule" title="下拉框"
                        ><span>下拉框</span>
                        <div class="menu-capsule style-green">文本</div></a
                      >
                    </li>
                    <li class="field" name="_widget_1493093397913">
                      <a class="menu-item with-capsule" title="复选框组"
                        ><span>复选框组</span>
                        <div class="menu-capsule style-purple">数组</div></a
                      >
                    </li>
                    <li class="field" name="_widget_1493093397892">
                      <a class="menu-item with-capsule" title="数字"
                        ><span>数字</span>
                        <div class="menu-capsule style-yellow">数字</div></a
                      >
                    </li>
                    <li class="field" name="_widget_1493093397868">
                      <a class="menu-item with-capsule" title="单选按钮组"
                        ><span>单选按钮组</span>
                        <div class="menu-capsule style-green">文本</div></a
                      >
                    </li>

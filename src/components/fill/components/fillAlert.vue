            ...
            >
              ...
              <div v-if="item.tagIcon == 'select_number'">
                ...
                <el-select
                  ...
                  :placeholder="item.placeholder"
                  size="medium"
                  @change="selectNChage($event, item)"
                >
                  <el-option
                    v-for="items in item.options"
...
export default {
  ...
  methods: {
    ...
    selectNChage (item, p_item) {
      console.log(item)
      // this.subClick()
      // console.log(item.split(']}__').length)
      // console.log(item.split(']}__'))
      // if (item.split(']}__').length < 2) {
      //   this.subClick()
      //   return false;
      // } else {
      //   this.countselected(item, p_item)
      // }
      this.subClick()
    ...
    submitClick () {
      ...
      for (let i in this.form_fields) {
        if (this.form_fields[i].required) {
          ...
          console.log(this.form_fields[i].label)
